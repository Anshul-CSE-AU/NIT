...
class DroneSimulation:
    ...
    def analyze_monkey_clusters(self):
        ...
        # Determine the number of clusters (max 5)
        n_components = min(5, len(self.monkey_positions) // 2)
        ...
        for i in range(n_components):
            cluster_points = np.array([p for p, l in zip(self.monkey_positions, labels) if l == i])
